...
Scenario: Aluno com notas preenchidas
	...
	When eu mudo para a pagina de metas
	And eu atribuo ao aluno com CPF "683" as notas "8" e "7" respectivamente
...
Scenario: Changing student grades, service
	Given o sistema guarda o aluno "Daniel" com CPF "999" e email "dap5@cin.ufpe.br" e notas "6" e "6"
	When o sistema envia o email de relatorio para o aluno com CPF "999"
	And the grades of the student "Daniel" with CPF "999" and email "dap5@cin.ufpe.br" are changed to "8" and "8"
	Then o sistema armazena "false" na variavel "emailEnviado" do aluno com CPF "999"
...
Scenario: Aluno com notas parcialmente preenchidas
	...
	When eu mudo para a pagina de metas
	And eu atribuo ao aluno com CPF "683" as notas "6" e "" respectivamente
...
Scenario: Aluno com email invalido
	...
	When eu mudo para a pagina de metas
	And eu atribuo ao aluno com CPF "12345678900" as notas "5" e "1" respectivamente
...
Scenario: Aluno com email invalido, serviço
	...
	When o sistema falha ao enviar email de relatorio para o aluno com CPF "778"
	Then o sistema armazena "false" na variavel "emailEnviado" do aluno com CPF "778"
...
Scenario: Aluno com metas invalidas
	...
	When eu mudo para a pagina de metas
	And eu atribuo ao aluno com CPF "05042316426" as notas "w" e "5" respectivamente
...
Scenario: Aluno com metas invalidas, serviço
	Given o sistema guarda o aluno "Gabriel" com CPF "779" e email "cgcc@cin.ufpe.br" e notas "5" e "z"
	When o sistema falha ao enviar email de relatorio para o aluno com CPF "779"
	Then o sistema armazena "false" na variavel "emailEnviado" do aluno com CPF "779"
